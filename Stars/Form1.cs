...
namespace Stars
{
...

    {
        ...
        private Star[] stars = new Star[7500];
        ...
        private void DrawStar(Star star)
        {
            ...
            graphics.FillEllipse(Brushes.LightGray, x, y, StarSize, StarSize);
        }
...

        {
            ...
            for (int i = 0;i<stars.Length;i++)
            {
                stars[i] = new Star();
                {
                    stars[i].X = random.Next(-pictureBox1.Width, pictureBox1.Width);
                    stars[i].Y = random.Next(-pictureBox1.Height, pictureBox1.Height);
                    stars[i].Z = random.Next(1, pictureBox1.Width);
